...
Vector<Size, Scalar> &operator+=(Vector<Size, Scalar> &lhs,
 ...
 */
template <int Size, typename Scalar>
Vector<Size, Scalar> operator+(const Vector<Size, Scalar> &lhs,
                               const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
Vector<Size, Scalar> multiplyComponents(const Vector<Size, Scalar> &lhs,
                                        const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
Scalar operator*(const Vector<Size, Scalar> &lhs,
                 const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
Scalar innerDot(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs);
...
Vector<3, Scalar> cross(const Vector<3, Scalar> &lhs,
                        const Vector<3, Scalar> &rhs);

/**
 * Compares to vectors on equality by means of a numerical accuracy.
 *
 * @param tolerance Absolute tolerance. If you prefer to use a relative
 *  measure, you might want to use tarch::la::relativeEps()
 */
template <int Size, typename Scalar>
bool equals(const Vector<Size, Scalar> &lhs, const Vector<Size, Scalar> &rhs,
 ...
 */
template <int Size, typename Scalar>
bool firstGreater(const Vector<Size, Scalar> &lhs,
                  const Vector<Size, Scalar> &rhs,
                  const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);
 ...
 */
template <int Size, typename Scalar>
bool oneGreater(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs,
                const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);
 ...
 */
template <int Size, typename Scalar>
bool oneGreaterEquals(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);
 ...
 */
template <int Size, typename Scalar>
bool allGreater(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs,
                const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

/**
 * Returns true, if all components of lVector are greater or equals than the
 * corresponding components in rVector up to numerical accuracy.
 */
template <int Size, typename Scalar>
bool allGreaterEquals(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

template <int Size, typename Scalar>
bool allSmaller(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs,
                const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

template <int Size, typename Scalar>
bool allSmallerEquals(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

template <int Size, typename Scalar>
bool oneSmaller(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs,
                const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

template <int Size, typename Scalar>
bool oneSmallerEquals(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);
 ...
 */
template <int Size, typename Scalar>
Vector<Size, Scalar> max(const Vector<Size, Scalar> &lhs,
                         const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
Vector<Size, Scalar> min(const Vector<Size, Scalar> &lhs,
                         const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
bool operator==(const Vector<Size, Scalar> &lhs,
                const Vector<Size, Scalar> &rhs);
 ...
 */
template <int Size, typename Scalar>
int equalsReturnIndex(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);

template <int Size>
int equalsReturnIndex(const Vector<Size, int> &lhs,
 ...
 */
template <int Size>
int countEqualEntries(const Vector<Size, int> &lhs,
                      const Vector<Size, int> &rhs);

template <int Size, typename Scalar>
int countEqualEntries(const Vector<Size, Scalar> &lhs,
                      const Vector<Size, Scalar> &rhs,
                      const Scalar tolerance = NUMERICAL_ZERO_DIFFERENCE);
} // namespace la
} // namespace tarch
