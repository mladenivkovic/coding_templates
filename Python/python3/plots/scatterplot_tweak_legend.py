...
fontP.set_family('monospace') # families = ['serif', 'sans-serif', 'cursive', 'fantasy', 'monospace']
fontP.set_style('oblique') # styles = ['normal', 'italic', 'oblique']
fontP.set_weight('black') # weights = ['light', 'normal', 'medium', 'semibold', 'bold', 'heavy', 'black']
...
ax1.scatter(x,z,s=30,alpha=1,lw=0,color='k', label='_nolegend_') # this one won't be in the legend!
