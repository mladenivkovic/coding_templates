...
program use_fftw
  ...
  my_plan = fftw_plan_dft_r2c_2d(Ny, Nx, arr_in, arr_out, FFTW_ESTIMATE)
  ! my_plan = fftw_plan_dft_r2c( 2, n, arr_in, arr_out, FFTW_ESTIMATE)
  ...
  do i = 1, nsamples
    ...
    write(666, '(2E14.5,x)') (distances_k(i-1)+distances_k(i))*pi, Pk(i)
  enddo
  close(666)
