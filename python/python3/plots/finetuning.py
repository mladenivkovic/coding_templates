...
if __name__ == "__main__":
    ...
    im1 = ax1.imshow(
        data_map, interpolation="kaiser", cmap="jet", norm=LogNorm(), origin="lower"
    )
    ...
    ax1.set_xticks([0, 51, 102, 153, 204, 255])
    ax1.set_yticks([0, 51, 102, 153, 204, 255])
    ...
    pyplot.figtext(
        0.05,
        0.07,
        "gridsize=" + str(int(gridsize)) + r" $\times$ " + str(int(gridsize)),
        family="serif",
        size=16,
    )
