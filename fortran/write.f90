program writing
  ...
  write(*, *) "rFw.d - repeat F width . digits_after_comma"
  write(*, *) " "
  write(*, '(F7.3)') somereal
  ...
  write(*,*) "rEw.d - repeat E width . digits"
  ...
  ! Therefore condition: w >= d + 7
  ! x is a space.
  write(*,*) "rEw.dEe - repeat E width . digits E exponent"
  ...
  write(*,*) "sPEw.dEe - scale PE width . digits E exponent"
  write(*,*) "1PE12.3E3, 2PE12.3E4, 3PE14.5E3"
  write(*, '(1PE12.3E3, 2PE12.3E4, 3PE14.5E3)') somereal, somereal, somereal
  write(*,*) " WARNING: P format descriptor changes scale for entire line or until next P!"
  write(*,*) " (F12.3, 1PE12.3E3, F12.3) for same real:" 
  write(*, '(F12.3, 1PE12.3E3, F12.3)') somereal, somereal, somereal
  write(*,*) ""
