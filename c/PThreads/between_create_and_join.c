/* ================================================================================ 
 * COMPILE WITH gcc -pthread ./between_create_and_join.c                                  
 *
 * Call some functions between pthread_create() and pthread_join() and see
 * what happens.
 *
 * ================================================================================ */
...
main(void)
{
  ...
  printf("[master]: Hello there!\n");
  printf("[master]: This is the master process speaking. I spawned two threads, and am now waiting for them to finish.\n");
  printf("[master]: As you can see, this message is printed only once.\n");
