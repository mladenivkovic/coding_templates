...

{
    ...
    {\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[width=\paperwidth]{Bilder/halostats_image_output_00041-halo-5440676.pdf}\hfil}\vfil}}
    \begin{frame}[plain]
        \frametitle{Full Page Image 1}
    \end{frame}
}

{
    \setbeamertemplate{background}
    {\vbox to \paperheight{\vfil\hbox to \paperwidth{\hfil\includegraphics[width=\paperwidth]{Bilder/test.jpg}\hfil}}}
    \begin{frame}[plain]
        \frametitle{Full Page Image 2}
    \end{frame}
}
