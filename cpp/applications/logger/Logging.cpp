...
void Log::logMessage(const char *file, const char *function, const int line,
...
void Log::logMessage(const char *file, const char *function, const int line,
                     std::stringstream &text, LogLevel level, LogStage stage) {
...
void Log::logWarning(const char *file, const char *function, const int line,
...
void Log::logError(const char *file, const char *function, const int line,
                   std::string text) {
...
const char *Log::getStageName(LogStage stage) {
  ...
  case LogStage::Undefined:
    return "Undefined";
  case LogStage::ProgramStage1:
    return "Program Stage 1";
  case LogStage::ProgramStage2:
    return "Program Stage 2";
  case LogStage::ProgramStage3:
    return "Program Stage 3";
  case LogStage::Count:
    return "Count";
  default:
    return "Unknown";
