 ...
 */
template <typename T> void my_formatted_print(const T &val_to_print) {
  std::cout << "Left fill:\n"
            << std::left << std::setfill('*') << std::setw(12) << val_to_print
            << '\n';
...
int main() {
  ...
  std::cout << "\nEnter some integer: ";
  std::cin >> a;
  // NOTE: `std::cin >> int i` works (compiles) too, but `i` will not be in
  // scope in the following lines.
  ...
  std::cout << "Setting width to 24, and filling up with '-':"
            << std::setfill('-') << std::setw(24) << i << std::endl;

  std::cout << "Aligning left, no width specified:" << std::left << i
            << std::endl;
  std::cout << "Aligning right, no width specified:" << std::right << i
            << std::endl;
  std::cout << "Aligning left with width=12:" << std::left << std::setw(12) << i
            << std::endl;
  std::cout << "Aligning right with width=12:" << std::right << std::setw(12)
            << i << std::endl;
  ...
  std::cout << "Setting 'fill' to '-'" << std::setfill('-') << std::endl;
  std::cout << "Using setw() only once for two variables:" << std::setw(12) << i
            << i << std::endl;
  std::cout << "Changing setw() mid-line" << std::setw(12) << i << std::setw(3)
            << i << std::endl;
  ...
  std::cout << "Setting width to 24, and filling up with '-':"
            << std::setfill('-') << std::setw(24) << f << std::endl;

  std::cout << "Aligning left, no width specified:" << std::left << f
            << std::endl;
  std::cout << "Aligning right, no width specified:" << std::right << f
            << std::endl;
  std::cout << "Aligning left with width=12:" << std::left << std::setw(12) << f
            << std::endl;
  std::cout << "Aligning right with width=12:" << std::right << std::setw(12)
            << f << std::endl;
  std::cout << "Setting 'fill' to ' '" << std::setfill(' ') << std::endl;
  ...
  std::cout << "Setting 'fill' to '-'" << std::setfill('-') << std::endl;
  std::cout << "Using setw() only once for two variables:" << std::setw(12) << f
            << f << std::endl;
  std::cout << "Changing setw() mid-line" << std::setw(12) << f << std::setw(8)
            << f << std::endl;

  std::cout << "Setting precision to 4: " << std::setprecision(4) << f
            << std::endl;
  std::cout << "Setting precision to 12: " << std::setw(15)
            << std::setprecision(12) << f << std::setw(15) << f << std::endl;
