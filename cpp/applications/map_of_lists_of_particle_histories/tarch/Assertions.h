...
#define assertion(expr)                                                        \
  if (!(expr)) {                                                               \
    ...
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
 ...
 * \code operator<< \endcode
 */
#define assertion7(expr, param0, param1, param2, param3, param4, param5,       \
                   param6)                                                     \
  if (!(expr)) {                                                               \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
 ...
 * \code operator<< \endcode
 */
#define assertion8(expr, param0, param1, param2, param3, param4, param5,       \
                   param6, param7)                                             \
  if (!(expr)) {                                                               \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
 ...
 * \code operator<< \endcode
 */
#define assertion9(expr, param0, param1, param2, param3, param4, param5,       \
...
#define assertion10(expr, param0, param1, param2, param3, param4, param5,      \
...
#define assertion11(expr, param0, param1, param2, param3, param4, param5,      \
...
#define assertion12(expr, param0, param1, param2, param3, param4, param5,      \
...
#define assertion13(expr, param0, param1, param2, param3, param4, param5,      \
...
#define assertion14(expr, param0, param1, param2, param3, param4, param5,      \
                    param6, param7, param8, param9, param10, param11, param12, \
                    param13)                                                   \
  if (!(expr)) {                                                               \
    setAssertionOutputFormat;                                                  \
...
#define assertion25(expr, param0, param1, param2, param3, param4, param5,      \
                    param6, param7, param8, param9, param10, param11, param12, \
 ...
 * \code operator<< \endcode
 */
#define assertionEquals1(lhs, rhs, larg)                                       \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
 ...
 * \code operator<< \endcode
 */
#define assertionEquals2(lhs, rhs, larg, rarg)                                 \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
 ...
 * \code operator<< \endcode
 */
#define assertionEquals3(lhs, rhs, larg, rarg, three)                          \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
 ...
 * \code operator<< \endcode
 */
#define assertionEquals8(lhs, rhs, larg, rarg, three, four, five, six, seven,  \
                         eight)                                                \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionEquals9(lhs, rhs, larg, rarg, three, four, five, six, seven,  \
                         eight, nine)                                          \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionEquals10(lhs, rhs, larg, rarg, three, four, five, six, seven, \
                          eight, nine, ten)                                    \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionEquals11(lhs, rhs, larg, rarg, three, four, five, six, seven, \
                          eight, nine, ten, p11)                               \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionEquals12(lhs, rhs, larg, rarg, three, four, five, six, seven, \
                          eight, nine, ten, p11, p12)                          \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
...
#define assertionEquals13(lhs, rhs, larg, rarg, three, four, five, six, seven, \
                          eight, nine, ten, p11, p12, p13)                     \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
...
#define assertionEquals14(lhs, rhs, larg, rarg, three, four, five, six, seven, \
                          eight, nine, ten, p11, p12, p13, p14)                \
  if ((lhs) != (rhs)) {                                                        \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
 ...
 * \code operator<< \endcode
 */
#define assertionNumericalEquals2(lhs, rhs, larg, rarg)                        \
  if (!tarch::la::equals((lhs), (rhs))) {                                      \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
              << " failed: " << #lhs << "==" #rhs << std::endl                 \
...
#define assertionNumericalEquals12(lhs, rhs, a, b, c, d, e, f, g, h, i, j, k,  \
                                   l)                                          \
  if (!tarch::la::equals((lhs), (rhs))) {                                      \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionNumericalEquals13(lhs, rhs, a, b, c, d, e, f, g, h, i, j, k,  \
                                   l, m)                                       \
  if (!tarch::la::equals((lhs), (rhs))) {                                      \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionNumericalEquals14(lhs, rhs, a, b, c, d, e, f, g, h, i, j, k,  \
                                   l, m, n)                                    \
  if (!tarch::la::equals((lhs), (rhs))) {                                      \
    setAssertionOutputFormat;                                                  \
    std::cerr << "assertion in file " << __FILE__ << ", line " << __LINE__     \
...
#define assertionVectorNumericalEquals(lhs, rhs)                               \
  assertion2(tarch::la::equals(lhs, rhs), lhs, rhs);
#define assertionVectorNumericalEquals1(lhs, rhs, param0)                      \
  assertion3(tarch::la::equals(lhs, rhs), lhs, rhs, param0);
#define assertionVectorNumericalEquals2(lhs, rhs, param0, param1)              \
  assertion4(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1);
#define assertionVectorNumericalEquals3(lhs, rhs, param0, param1, param2)      \
  assertion5(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2);
#define assertionVectorNumericalEquals4(lhs, rhs, param0, param1, param2,      \
                                        param3)                                \
  assertion6(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,    \
             param3);
#define assertionVectorNumericalEquals5(lhs, rhs, param0, param1, param2,      \
                                        param3, param4)                        \
  assertion7(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,    \
             param3, param4);
#define assertionVectorNumericalEquals6(lhs, rhs, param0, param1, param2,      \
                                        param3, param4, param5)                \
  assertion8(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,    \
             param3, param4, param5);
#define assertionVectorNumericalEquals7(lhs, rhs, param0, param1, param2,      \
                                        param3, param4, param5, param6)        \
  assertion9(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,    \
             param3, param4, param5, param6);
#define assertionVectorNumericalEquals8(                                       \
    lhs, rhs, param0, param1, param2, param3, param4, param5, param6, param7)  \
  assertion10(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,   \
              param3, param4, param5, param6, param7);
#define assertionVectorNumericalEquals9(lhs, rhs, param0, param1, param2,      \
                                        param3, param4, param5, param6,        \
                                        param7, param8)                        \
  assertion11(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,   \
              param3, param4, param5, param6, param7, param8);
#define assertionVectorNumericalEquals10(lhs, rhs, param0, param1, param2,     \
                                         param3, param4, param5, param6,       \
                                         param7, param8, param9)               \
  assertion12(tarch::la::equals(lhs, rhs), lhs, rhs, param0, param1, param2,   \
...
#define assertionFail(message)                                                 \
  {                                                                            \
    setAssertionOutputFormat;                                                  \
    std::cerr << "fail-assertion in file " << __FILE__ << ", line "            \
              << __LINE__ << std::endl                                         \
              << message << std::endl;                                         \
    std::cerr.flush();                                                         \
    assertionTriggersExit;                                                     \
