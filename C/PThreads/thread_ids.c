...
main(void)
{
  ...
  pthread_create(&thread1,        /* pointer to a buffer for thread "ID"                                         */
          ...
          (void *) check_id,      /* pointer to routine at which new thread will start executing                 */
           NULL);                  /* pointer to parameter to be passed to the routine at which new thread starts */
  /* returns: 0 for success, nonzero for errors */


  pthread_create(&thread2, NULL, (void *) check_id, NULL);
  pthread_create(&thread3, NULL, (void *) check_id, NULL);
  pthread_create(&thread4, NULL, (void *) check_id, NULL);
  pthread_create(&thread5, NULL, (void *) check_id, NULL);
