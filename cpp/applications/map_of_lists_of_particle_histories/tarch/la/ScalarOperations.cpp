...
bool tarch::la::greaterEquals(double lhs, double rhs, double tolerance) {
  return lhs - rhs >= -tolerance;
}
...
bool tarch::la::smallerEquals(double lhs, double rhs, double tolerance) {
  return lhs - rhs <= tolerance;
}
...
bool tarch::la::equals(const std::complex<double> &lhs,
                       const std::complex<double> &rhs, double tolerance) {
  return (std::abs(rhs.real() - lhs.real()) <= tolerance) &&
