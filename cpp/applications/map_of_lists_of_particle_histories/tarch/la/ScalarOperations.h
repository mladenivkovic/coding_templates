 ...
 * @param tolerance Absolute tolerance when we compare two values.
 */
bool greaterEquals(double lhs, double rhs,
                   double tolerance = NUMERICAL_ZERO_DIFFERENCE);
 ...
 * @param tolerance Absolute tolerance when we compare two values.
 */
static bool smaller(double lhs, double rhs,
                    double tolerance = NUMERICAL_ZERO_DIFFERENCE) {
 ...
 * @param tolerance Absolute tolerance when we compare two values.
 */
bool smallerEquals(double lhs, double rhs,
                   double tolerance = NUMERICAL_ZERO_DIFFERENCE);

/**
 * @param tolerance Absolute tolerance when we compare two values.
 */
bool equals(const std::complex<double> &lhs, const std::complex<double> &rhs,
            double tolerance = NUMERICAL_ZERO_DIFFERENCE);
