...
int main() {
  ...
  // This fails due to the name clash in the namespaces. gcc won't compile it
  // and throws an error. std::cout << "Global nameclash var: " <<
  // global_nameclash_var;

  std::cout << "Global nameclash var: "
            << some_namespace_with_nameclash::global_nameclash_var << std::endl;
  std::cout << "Global nameclash var: " << ::global_nameclash_var
            << std::endl; // this uses the global namespace.

  std::cout << "Split namespace var1: "
            << some_namespace_split_among_multiple_files::var1 << std::endl;
  std::cout << "Split namespace var2: "
            << some_namespace_split_among_multiple_files::var2 << std::endl;
