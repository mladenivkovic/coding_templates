...
std::string bitwise_representation(T val, std::string prefix = ""){
  ...
  for (size_t i = sizeof(T) * 8; i > 0; i--) {
    ...
    if (verbose) std::cout << "i=" << i-1 << " digit=" << digit << " res=" << result << std::endl;
  } 
...
int main(){
  ...
  std::cout << bitwise_representation(static_cast<char>(!a), "!a = "); 
    std::cout << " Note that this is not a bitwise operation. This is a logical operation." << std::endl;
  std::cout << bitwise_representation(static_cast<char>(~a), "~a = ") << std::endl;

  std::cout << std::endl;
  std::cout << bitwise_representation(static_cast<char>(1),       "1 =       ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(1 << 3),  "1 << 3 =  ") << std::endl;
  std::cout << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23),      "23 =      ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 << 0), "23 << 0 = ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 << 1), "23 << 1 = ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 << 2), "23 << 2 = ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 << 5), "23 << 5 = ") << std::endl;
  std::cout << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23),      "23 =      ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 >> 0), "23 >> 0 = ") << std::endl;
  std::cout << bitwise_representation(static_cast<char>(23 >> 1), "23 >> 1 = ") << std::endl;
