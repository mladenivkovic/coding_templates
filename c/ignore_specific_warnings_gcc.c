...
#pragma GCC diagnostic ignored "-Wuninitialized" /* ignore uninitialized vars warnings */
#pragma GCC diagnostic ignored "-Wmissing-braces" /* ignore missing braces warning for int a[2][2] */
